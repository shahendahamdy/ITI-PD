...
select s.SalesOrderID,ShipDate
...
select sum(TotalDue ) As sumOfTotal from Sales.SalesOrderHeader where OrderDate  between '7/1/2001' and '7/31/2014'
...
select 'The [ '+p.Name +' ] is only! [' +convert(char,p.ListPrice)+' ]'
from Production.Product p
